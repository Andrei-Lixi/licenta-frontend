...
function App() {
  ...
  // Apelăm hook-ul useAuthToken în interiorul componentei
  const { token, removeToken } = useAuthToken();

  // Functia pentru logout
  const handleLogout = () => {
    removeToken(); // Șterge token-ul
    navigate("/Register"); // Redirecționează către login
  };
      ...
      <div style={containerStyle}>
        ...
        <div style={mapContainerStyle}>
          <MapContainer 
            ...
            style={{ height: "100%" }}
            maxBounds={[
              [43.5, 20.5], // Limită sud-vest
              [48.5, 30.5], // Limită nord-est
            ]}
        ...
        <div style={descriptionContainerStyle}>
          <h2>Explorează Regiunile României</h2>
